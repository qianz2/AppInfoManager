...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        <form class="form-horizontal form-label-left" action="${pageContext.request.contextPath }/dev/appinfomodeifySave.html" method="post" enctype="multipart/form-data">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
            	<input id="statusName" type="text" class="form-control col-md-7 col-xs-12" 
              	name="statusName" value="${appinfo.svalueName}" readonly="readonly">
            </div>
          </div>
          <div class="item form-group">
          ...
          <div class="form-group">
            ...
            <c:if test="${appinfo.svalueName != '待审核'}">
