    ...
    <div class="x_panel">
	  ...
	  <p class="text-muted font-13 m-b-30"></p>
			...
			<div class="row">
				<div class="col-sm-12">
					<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline collapsed"
						...
						<tbody>
						<c:forEach var="appVersion" items="${appVersion}">
        ...
        <form class="form-horizontal form-label-left" action="${pageContext.request.contextPath}/dev/appversionmodifySave.html" method="post" enctype="multipart/form-data">
           <input type="hidden" name="id" id="id" value="${appVersion123.id}">
           <input type="hidden" name="appId" id="appId" value="${appVersion123.appId}">
          <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">版本号 <span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input class="form-control col-md-7 col-xs-12" value="${appVersion123.versionNo }" 
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="number" id="versionSize" name="versionSize" value="${appVersion123.versionSize }"  required="required"
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              ${appVersion123.versionInfo }</textarea>
            </div>
          </div>
           <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
            <input type="hidden" id="downloadLink" name="downloadLink" value="${appVersion123.downloadLink}"/>
            <input type="hidden" id="apkLocPath" name="apkLocPath" value="${appVersion123.apkLocPath}"/>
            <input type="hidden" id="apkFileName" name="apkFileName" value="${appVersion123.apkFileName}"/>
