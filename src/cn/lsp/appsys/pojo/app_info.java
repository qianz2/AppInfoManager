...
public class app_info {
	...
	private String supportROM;		//֧支持ROM
	...
	private Integer flatformId;			//所属时间
	private Date offSaleDate;			//下架平台（来源于：data_dictionary，1 手机 2 平板 3 通用）
	...
	private Integer modifyBy;			//更新者（来一级分类（来源源于dev_user开发者信息表的用户id）
	private Date modifyDate;			//最新更新时间
	private Integer categoryLevel1;		//所属于：data_dictionary）
